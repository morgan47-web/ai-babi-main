  ...
  return (
    <div className={`grid h-full grid-cols-1 grid-rows-[1fr,auto]`}>
      <div
        ...
        `}
      >
        <div className="flex flex-col space-y-1 px-2 pt-4 text-center">
          <h1
            className={`
              w-full  text-[24px] leading-[30px] text-white-secondary
            `}
          >
            <Trans>Get tokens</Trans>
          </h1>
          <h5 className="text-sm leading-[20px] text-tertiary-text text-center">
            <Trans>
        ...
        <div className="flex w-[60vw] max-sm:w-[90vw] flex-col items-center space-y-2 px-1 py-2">
