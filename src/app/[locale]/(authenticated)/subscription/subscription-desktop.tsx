...
export default function Subscriptions({
  ...
  return (
    <main className="flex w-full h-full flex-1 flex-col items-center justify-top gap-4 p-4 px-3">
          ...
          filteredPlans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={cn(
                  `w-[400px] rounded-3xl  border-[3px] p-[20px] cursor-pointer transition-all ${plan.name == "Premium" ? "bg-premium-gradient" : "bg-deluxe-gradient"} `,
                  isSelected ? "border-[#ff5c5c]" : "border-[#333] "
                )}
